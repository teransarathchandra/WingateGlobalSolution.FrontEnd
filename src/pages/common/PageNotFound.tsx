  ...
  return (
    ...
    <div className="row">
      ...
      <div className="col-md-6 align-self-center">
        ...
        <h2 className='sub-heading-not-found'>UH OH! You're lost.</h2>
        <p className='description-not-found'>The page you are looking for does not exist.
          How you got here is a mystery. But you can click the button below
          to go back to the homepage.
        </p>
        <button className="btn yellow" onClick={routeChange}>HOME</button>
      </div>
    </div>
  </div>
  );
